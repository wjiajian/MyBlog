...
export const MobileDrawer: React.FC<MobileDrawerProps> = ({
  ...
  // 展开态高度（屏幕高度的 60%）
  const EXPANDED_HEIGHT = typeof window !== 'undefined' ? window.innerHeight * 0.6 : 400;
            ...
            >
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                <div className="relative w-12 h-12 rounded-lg overflow-hidden flex-shrink-0">
                  <img
                    src={selectedImage.srcTiny || selectedImage.srcMedium || selectedImage.src}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/50 text-xs">
                    {(selectedImage.format || selectedImage.filename.split('.').pop())?.toUpperCase()} · {formatResolution(fullDimensions?.w || selectedImage.width, fullDimensions?.h || selectedImage.height)}
                  </p>
                </div>
              </div>
              {/* 右侧：照片索引 */}
              ...
              {activeTab === 'info' ? (
                <div className="flex-1 flex flex-col min-h-0">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between">
                          ...
                          <span className="text-white text-sm font-medium truncate max-w-[180px]" title={selectedImage.filename}>
                            {selectedImage.filename.replace(/\.(jpg|jpeg|png|webp|heic)$/i, '')}
                          </span>
                        </div>
                        <div className="flex justify-between">
                  ...
                  <div className="flex-shrink-0 pt-3 border-t border-white/10">
                    <h3 className="text-white/50 text-xs uppercase tracking-wider mb-2">快速预览</h3>
